...
(package! verus-mode
  :recipe
  (if (file-directory-p "/home/jayb/projects/verus/verus-mode.el")
      '(:local-repo "/home/jayb/projects/verus/verus-mode.el"
        :build (:not compile))
    '(:host github :repo "verus-lang/verus-mode.el" :branch "dev")))
