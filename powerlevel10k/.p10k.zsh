# Generated by Powerlevel10k configuration wizard on 2020-06-29 at 18:09 EDT.
...
if command -v jj >/dev/null; then
  function prompt_my_jj_commit() {
    local result
    result=$(jj show @ --ignore-working-copy --color=always --summary --template 'separate(" ", change_id.shortest(4), commit_id.shortest(4), if(empty,"(empty)")) ++ "\n"' 2>/dev/null | head -1 | sed -e 's/\x1b\[1m/%B/g' -e 's/\x1b\[38;5;\([0-9]*\)m/%F{\1}/g' -e 's/\x1b\[0m/%f%b/g' -e 's/\x1b\[39m/%f/g')
